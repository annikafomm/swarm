...
central_gene_modules<-get_central_modules(central_nodes = top_genes, node_centrality = filtered_network_centralities$Node_Centrality, ceRNA_class = RNAs, centrality_measure = "Weighted_Degree", cutoff = 10)
